...
export const metadata: Metadata = {
  ...
  description: "How Inklings's kid Studio works for ages 4 and up. Voice STT with tap-button fallback. No reading required. Bounded branching with Sparky.",
};
        ...
        <div className="container-ink section">
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mt-6 text-lg text-ink-700">
              Most apps for kids 4 and up assume the kid can read. Most kids 4 and up can&apos;t — at least not at the speed needed to enjoy a creative tool. Inklings flips it: your child <em>talks</em> to Sparky, and Sparky narrates the story back. Reading is optional everywhere.
            </p>
          </div>
        </div>
      </section>

          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3">
            <div>
              ...
              <ul className="space-y-2 text-sm text-cream-200/80">
                ...
                <li><Link href="/features" className="transition-colors hover:text-coral">Features</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-cream-200/80">
                ...
                <li>
                  <Link href="/legal/terms#cancellation" className="font-semibold text-coral transition-colors hover:text-cream-100">
